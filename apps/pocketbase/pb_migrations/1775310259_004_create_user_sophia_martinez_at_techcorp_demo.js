...
migrate((app) => {
  ...
  record.set("email", "sophia.martinez@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Sophia");
  ...
  record.set("job_title", "Operations Coordinator");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "sophia.martinez@techcorp.demo");
    app.delete(record);
  } catch (e) {
