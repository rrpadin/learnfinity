...
migrate((app) => {
  ...
  record.set("email", "christopher.davis@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Christopher");
  record.set("last_name", "Davis");
  ...
  record.set("job_title", "Content Creator");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "christopher.davis@techcorp.demo");
    app.delete(record);
  } catch (e) {
