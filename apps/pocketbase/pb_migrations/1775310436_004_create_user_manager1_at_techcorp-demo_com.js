...
migrate((app) => {
  ...
  record.set("email", "manager1@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Michael");
  record.set("last_name", "Chen");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "manager1@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
