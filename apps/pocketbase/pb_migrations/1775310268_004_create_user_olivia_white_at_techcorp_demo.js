...
migrate((app) => {
  ...
  record.set("email", "olivia.white@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Olivia");
  record.set("last_name", "White");
  ...
  record.set("job_title", "Business Analyst");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "olivia.white@techcorp.demo");
    app.delete(record);
  } catch (e) {
