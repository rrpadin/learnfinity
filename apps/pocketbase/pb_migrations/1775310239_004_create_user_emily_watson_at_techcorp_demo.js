...
migrate((app) => {
  ...
  record.set("email", "emily.watson@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Emily");
  record.set("last_name", "Watson");
  ...
  record.set("job_title", "Senior Engineer");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "emily.watson@techcorp.demo");
    app.delete(record);
  } catch (e) {
