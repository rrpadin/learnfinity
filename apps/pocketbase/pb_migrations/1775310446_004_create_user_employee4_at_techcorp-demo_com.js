...
migrate((app) => {
  ...
  record.set("email", "employee4@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Jennifer");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "employee4@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
