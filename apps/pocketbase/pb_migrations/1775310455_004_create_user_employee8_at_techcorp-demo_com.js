...
migrate((app) => {
  ...
  record.set("email", "employee8@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Michelle");
  record.set("last_name", "Garcia");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "employee8@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
