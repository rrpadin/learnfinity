...
migrate((app) => {
  ...
  record.set("email", "learner2@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Mark");
  record.set("last_name", "Lewis");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "learner2@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
