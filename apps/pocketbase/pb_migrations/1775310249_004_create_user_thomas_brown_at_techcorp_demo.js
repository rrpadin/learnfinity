...
migrate((app) => {
  ...
  record.set("email", "thomas.brown@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Thomas");
  record.set("last_name", "Brown");
  ...
  record.set("job_title", "Account Executive");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "thomas.brown@techcorp.demo");
    app.delete(record);
  } catch (e) {
