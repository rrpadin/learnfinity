...
migrate((app) => {
  ...
  record.set("email", "manager2@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Emily");
  record.set("last_name", "Rodriguez");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "manager2@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
