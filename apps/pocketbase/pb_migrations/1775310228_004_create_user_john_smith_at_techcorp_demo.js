...
migrate((app) => {
  ...
  record.set("email", "john.smith@techcorp.demo");
  ...
  record.set("job_title", "Chief Learning Officer");
  record.set("department", "Learning & Development");
  try {
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "john.smith@techcorp.demo");
    app.delete(record);
  } catch (e) {
