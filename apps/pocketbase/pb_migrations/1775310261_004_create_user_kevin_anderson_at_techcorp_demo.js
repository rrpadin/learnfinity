...
migrate((app) => {
  ...
  record.set("email", "kevin.anderson@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Kevin");
  record.set("last_name", "Anderson");
  ...
  record.set("job_title", "Systems Administrator");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "kevin.anderson@techcorp.demo");
    app.delete(record);
  } catch (e) {
