...
migrate((app) => {
  ...
  record.set("email", "employee10@techcorp-demo.com");
  record.setPassword("DemoPass123!");
  record.set("first_name", "Rachel");
  record.set("last_name", "Thompson");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "employee10@techcorp-demo.com");
    app.delete(record);
  } catch (e) {
