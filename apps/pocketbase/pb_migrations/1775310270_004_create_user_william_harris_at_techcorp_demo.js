...
migrate((app) => {
  ...
  record.set("email", "william.harris@techcorp.demo");
  record.setPassword("DemoPass123!");
  record.set("first_name", "William");
  record.set("last_name", "Harris");
  ...
  record.set("job_title", "Customer Success Manager");
  ...
  try {
    const record = app.findFirstRecordByData("users", "email", "william.harris@techcorp.demo");
    app.delete(record);
  } catch (e) {
